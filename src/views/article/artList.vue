  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="artList" style="width: 100%;" border stripe>
        ...
        <el-table-column label="发表时间" prop="pub_date"> <template v-slot="{ row }">
...
<script>
import { getArtCateAPI, uploadArticleAPI, getArticleListAPI, getArticleDetailFn, delArticleAPI } from '@/api/index.js'
...
export default {
  ...
  data () {
    return {
      ...
      q: {
        pagenum: 1, // 默认拿第一页的数据
        pagesize: 3, // 默认当前页需要几条数据（传递给后台，后台就返回几条数据）
        cate_id: '',
        state: ''
      },
      pubDialogVisible: false, // 控制发布文章对话框的显示与隐藏
      pubForm: { // 表单的数据对象
        title: '',
        cate_id: '',
        content: '', // 文章的内容
